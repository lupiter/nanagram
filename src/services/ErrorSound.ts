/**
 * ErrorSound - Plays error sounds using Web Audio API
 */
export class ErrorSound {
  private static instance: ErrorSound;
  private audioContext: AudioContext | null = null;
  private isInitialized = false;

  static getInstance(): ErrorSound {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
    ErrorSound.instance ??= new ErrorSound();
    return ErrorSound.instance;
  }
...
export const errorSound = ErrorSound.getInstance();
