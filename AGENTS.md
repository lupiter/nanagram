* Prefer writing new unit tests to manual testing
* Ask before adding new libraries
* Ask before adding new routes
* Always write functional React components
* Don't add new emoji to the UI, make SVG icons
* Prefer semantic html
* The visual style of this app is "scrapbook". Keep to it!
